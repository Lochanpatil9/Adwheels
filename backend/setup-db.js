...
async function setupSchema() {
  console.log('🗄️  Creating database schema & storage buckets...\n')
  ...
  console.error('   ❌ Automatic schema creation failed.')
  console.error('   This is normal — Supabase restricts DDL via API for security.\n')
  console.error('   👉 Please copy the SQL from backend/schema.sql and run it in:')
  console.error('      Supabase Dashboard → SQL Editor → New query → Paste → Run\n')
  console.error('   After that, run: npm run seed')
  process.exit(1)
}
